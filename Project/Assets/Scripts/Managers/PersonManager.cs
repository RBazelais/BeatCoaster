...
public class PersonManager : MonoBehaviour {
	...
	public void DropPeople() {
		...
		for(int i = 0; i < toDrop.Length; i++) {
			var person = toDrop[i];
			peopleKillSequence.Insert(i * 7.5f/collectedPeople.Count, person.transform.DOMove(new Vector3(20, UnityEngine.Random.Range(-10,10), 0), .33f).SetRelative(true).OnStart(() => {
				person.Reset();
